...
for bx in [1, 2, 4, 8, 16, 32, 64, 128, 256, 512]:
	for by in [2, 4, 8, 16, 32, 64, 128, 256, 512]:
		if bx*by < 1024:
			f=open("run_dirac_" + str(bx) + "_" + str(by) + ".sh", "w")
			f.write(pre + "\n")
			f.write("./mmpy_" + str(bx) + "_" + str(by) + " -n 256 -r 5\n")
			f.write("./mmpy_" + str(bx) + "_" + str(by) + " -n 512 -r 5\n")
			f.write("./mmpy_" + str(bx) + "_" + str(by) + " -n 1024 -r 5\n")
			f.write(post)
			f.close()

			os.system("make clean")
			os.system("make bx=" + str(bx) + " by=" + str(by))
			os.system("qsub run_dirac_" + str(bx) + "_" + str(by) + ".sh")
